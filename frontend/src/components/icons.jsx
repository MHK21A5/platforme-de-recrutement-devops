// Minimal inline SVG icons (lucide-style) so we don't pull an extra dep.
// Each accepts standard SVG props (size, color inherited via currentColor).
...
export const LayoutDashboardIcon = make(
  <>
...
export const VideoOffIcon = make(
  <>
...
export const PhoneIcon = make(
  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.07 10a19.79 19.79 0 0 1-3.07-8.63A2 2 0 0 1 2.92 1H6a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.09 8.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 21 16z" />
);

export const PhoneOffIcon = make(
  <>
    <path d="M10.68 13.31a16 16 0 0 0 3.41 2.6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7 2 2 0 0 1 1.72 2v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.42 19.42 0 0 1 4.26 9.11a19.79 19.79 0 0 1-3.07-8.63A2 2 0 0 1 3.37 2.5h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11z" />
    <line x1="2" x2="22" y1="2" y2="22" />
  </>
);
...
export const WifiOffIcon = make(
  <>
    ...
    <path d="M1.42 9a16 16 0 0 1 4.72-2.56" />
    <path d="M21 6.77a16 16 0 0 0-4.72-2.56" />
